...
"Wake up at 6:30. French press coffee, two scoops of the Ethiopian blend from Trader Joe's. Read for 20 minutes — currently working through \"Thinking, Fast and Slow\" by Kahneman. Quick stretch routine from the PT, then shower and out by 8."

create_note "Pasta Carbonara (Nonna's Version)" \
...
"Max out 401k before year-end (\$23,000 limit). Harvest losses in the brokerage account — the NVIDIA position has unrealized losses we can pair against the Apple gains. Backdoor Roth conversion in January. Sarah mentioned the QBI deduction might apply to the consulting income."

create_note "Backyard Deck Project" \
"Pressure-treated lumber for the frame, composite decking boards on top (Trex Transcend in \"Spiced Rum\"). Need 16 footers for the joists, 12-inch spacing. Footings must be below frost line — contractor says 36 inches here. Budget: \$8,500 materials + \$4,000 labor. HOA approval needed before breaking ground."

create_note "Barcelona Trip Planning" \
"Direct flight on Delta, leaves JFK at 9pm Tuesday. Airbnb in El Born neighborhood — walking distance to the Gothic Quarter. Must-see: Sagrada Familia (book tickets online, sells out), Mercat de la Boqueria for lunch, Park Güell for sunset. Day trip to Montserrat by train. Pack a light jacket, evenings are cool in October."

create_note "1:1 with Marcus — Performance Review Prep" \
...
"Tesla Model Y: 330 mi range, Supercharger network, \$45k after incentives. Hyundai Ioniq 5: 303 mi, faster 800V charging architecture, \$41k. BMW iX xDrive50: 324 mi, luxury interior, \$65k. The federal tax credit (\$7,500) applies to all three. Home charger install quote: \$1,200 for a 240V/48A circuit in the garage. Break-even vs gas at ~45,000 miles."
